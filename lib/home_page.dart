...
import 'package:simple_pokemon_tutorial/button.dart';
import 'package:simple_pokemon_tutorial/characters/boy.dart';
import 'package:simple_pokemon_tutorial/characters/oak.dart';
import 'package:simple_pokemon_tutorial/maps/littleroot.dart';
import 'package:simple_pokemon_tutorial/maps/pokelab.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  // professor oak
  String oakDirection = "front"; // Up Down Left Right
  ...
  double step = 0.25; // step for littleroot
  static double stepLab = 0.43; // step for pokelab
